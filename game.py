...
def win_screen():
    ...
    win_text = Text(display_dimensions, (0, -200), "Congratulations..You Won!!!", 60, black)
...
def options_menu():
    ...
    about_text = Text(display_dimensions, (0, 350), "PyGame", 14, black)
